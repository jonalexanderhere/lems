    ...
    <section ref={containerRef} className="py-32 md:py-48 bg-background relative overflow-hidden border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-5xl mx-auto space-y-16 md:space-y-24">
          ...
          <div className="space-y-2 font-heading font-bold text-5xl md:text-8xl lg:text-[9rem] uppercase tracking-tighter leading-[0.85]">
          ...
          <div className="space-y-8 md:space-y-12 pl-4 md:pl-8 border-l-2 border-accent/30">
            <div className="overflow-hidden">
              <p className="statement-line text-2xl md:text-5xl text-white/60 font-light leading-tight">
